/*amd /cm/template/design_system/design_system.xml 18565 d0b314704fa605ae2b39eb2d2bf22468a6454d1f7425051643116597df8659ab */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
      ...
      E: [{
        ...
        A: {
          ...
          src: '/cm/template/design_system/studioAPI.js'
        }
      }, {
        T: 1,
        N: 'script',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.jsonDataCallBack = function (jsonData) {
                ...
                categoryMenuGen.getChild(genCatogoryFixMenuIdx, 'categoryMenuIcon').setSrc('/cm/images/base/ico_favorit.png');
        ...
        E: [{
          ...
          E: [{
            ...
            A: {
              ...
              emptyIndex: '1',
              noResult: 'useData',
              'ev:onviewchange': 'scwin.atc_search_onviewchange',
              allOption: '',
              chooseOption: '',
              ref: '',
              placeholder: 'Search...'
            ...
            E: [{
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    id: 'resourceIcon',
                    src: '/cm/template/snippets/00_화면시작/0_01%20페이지시작_icon.png',
                    style: '',
                    tabIndex: '',
                  ...
                  E: [{
                    ...
                    A: {
                      ...
                      outerDiv: 'false',
                      style: '',
                      'ev:onclick': 'scwin.btn_popup_onclick'
                    },
                    E: [{
                      T: 1,
                      N: 'xf:label',
            ...
            E: [{
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    id: '',
                    src: '/cm/template/snippets/00_화면시작/01_페이지시작_icon.png',
                    style: '',
                    tabIndex: ''
                  }
                }, {
