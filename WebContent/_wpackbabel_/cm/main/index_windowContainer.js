/*amd /cm/main/index_windowContainer.xml 5730 bbf1335820f04432ac9d83d3a3ec4b9cfb20bc05581e8c50a032c8da76104139 */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
      ...
      E: [{
        ...
        E: [{
          T: 1,
          N: 'xf:instance',
          _xml: '<xf:instance xmlns:xf="http://www.w3.org/2002/xforms">\n				<data xmlns="">\n				</data>\n			</xf:instance>'
        }]
      }, {
        T: 1,
        N: 'w2:layoutInfo'
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                frameMode: 'wframe',
                hideTitleOnMaximize: 'false',
                id: 'wdc_main',
                spaInitCount: '0',
                stopMinimizeOnNameLayer: 'true',
                stopToggleOnLast: 'false',
                style: '',
                toolbarPosition: 'top',
                tooltipDisplay: 'true',
                tooltipGroupClass: 'false',
                useCloseButton: 'true',
                useControlIconTitle: 'false',
                useCustomMsg: 'false',
                useFixButton: 'true',
                ...
                windowMaximizeAll: 'false',
                windowTooltipDisplay: 'true',
                closeType: '',
                'ev:onbeforecloseall': 'scwin.wdc_main_onbeforecloseall',
              ...
              A: {
                id: '',
                style: 'position: absolute;bottom:40px;left:10px;min-width:calc( 98% - 20px );z-index: 9980;'
              },
              E: [{
                T: 1,
                N: 'xf:group',
                ...
                E: [{
                  ...
                  E: [{
                    ...
                    N: 'xf:trigger',
                    A: {
                      'ev:onclick': 'scwin.removeWarnMsg',
                      disabled: '',
                      style: '',
                      id: 'btn_warnig',
                      type: 'button',
                ...
                E: [{
                  ...
                  E: [{
                    ...
                    N: 'xf:trigger',
                    A: {
                      'ev:onclick': 'scwin.removeErrorMsg',
                      disabled: '',
                      style: '',
                      id: 'btn_error',
                      type: 'button',
