/*amd /cm/xml/side.xml 16280 b54170c5f0acac7c460ee4adc21afcf96ed35804c663d05da8a3ded2a2a27d95 */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
      ...
      E: [{
        ...
        E: [{
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_selectFavList',
            ref: '',
            target: 'data:json,dlt_fav',
            action: '/main/selectFavList',
            method: 'post',
          ...
          A: {
            id: 'sbm_updateFav',
            ref: 'data:json,dma_fav',
            target: '',
            action: '/main/updateFav',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.setupdateFavCallback',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }]
      ...
      E: [{
        ...
        E: [{
          ...
          E: [{
            ...
            N: 'w2:anchor',
            A: {
              "class": 'btn_fold_list on',
              id: 'btn_menuExpandAll',
              outerDiv: 'false',
              style: '',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                "class": '',
                'ev:onclick': 'scwin.anc_menu_onclick',
                id: 'anc_menu',
                outerDiv: 'false',
                style: ''
              },
            ...
            E: [{
              ...
              N: 'w2:anchor',
              A: {
                'ev:onclick': 'scwin.anc_menu02_onclick',
                id: 'anc_menu02',
                outerDiv: 'false',
                style: ''
              },
          ...
          E: [{
            ...
            A: {
              interactionMode: '',
              chooseOptionValue: 'none',
              chooseOptionLabel: '메뉴를 검색하세요',
              chooseOption: 'true',
              displayMode: 'label',
              'ev:onviewchange': 'scwin.acb_search_onviewchange',
              id: 'acb_search',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                labelclass: '',
                toggleEvent: 'onclick',
                'ev:onclick': 'scwin.trv_menu_onclick',
                lineShow: 'false',
                style: '',
                id: 'trv_menu',
                "class": 'tw_menu',
            ...
            E: [{
              ...
              A: {
                ...
                id: 'trv_favMenu',
                "class": 'tw_menu',
                'ev:onclick': 'scwin.btn_FavMenuNode_onclick',
                toggleEvent: 'onclick',
                renderType: 'virtual'
              },
              E: [{
        ...
        E: [{
          ...
          E: [{
            ...
            A: {
              outerDiv: 'false',
              'ev:onclick': 'scwin.btn_history_clear_onclick',
              style: '',
              id: 'btn_history_clear',
          ...
          E: [{
            ...
            E: [{
              ...
              E: [{
                ...
                A: {
                  outerDiv: 'false',
                  'ev:onclick': 'scwin.btn_History_onclick',
                  style: '',
                  id: 'btn_History',
                  "class": 'on'
                },
