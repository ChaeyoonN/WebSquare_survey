/*amd /cm/xml/contentHeader.xml 3793 72e1cb7ae6de71cccfe269ca6e63eb9d2d40028fbbff69d859fb23c8c536dcbd */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.showScreenInfo = function () {
                ...
                com.win.alert($p, '[' + txt_h1.getValue() + '] 페이지의 파일 경로는 다음과 같습니다.\n' + pageUrl);
              };
      ...
      E: [{
        ...
        E: [{
          ...
          A: {
            "class": 'btn_fav',
            'ev:onclick': 'scwin.btn_fav_onclick',
            id: 'btn_fav',
            style: '',
            type: 'button',
            toolTip: '즐겨찾기를 추가/해제합니다'
          },
          E: [{
            T: 1,
            N: 'xf:label'
          ...
          E: [{
            ...
            N: 'xf:trigger',
            A: {
              'ev:onclick': 'scwin.showScreenInfo',
              style: '',
              id: '',
              type: 'button',
              title: '화면 정보',
              "class": 'btn_cm btn_guide'
            },
            E: [{
              T: 1,
              N: 'xf:label'
            ...
            N: 'xf:trigger',
            A: {
              'ev:onclick': 'scwin.reload',
              style: '',
              id: '',
              type: 'button',
              title: '화면 갱신',
              "class": 'btn_cm btn_refresh'
            },
            E: [{
              T: 1,
              N: 'xf:label'
