/*amd /ui/SP/GridView/GridView_Excel_AdvancedUpload.xml 33786 8ea37698a5311d6bfaac4072600bc820f2173427e5e000f91eb1847cbefa9007 */
define({
  declaration: {
    A: {
      version: '1.0',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.btn_settingCodeView_onclick = function () {
                var xlsxOption = dma_optionsSetting.getModifiedKey();
                var csvOption = dma_csvOptionSetting.getModifiedKey();
                var value = [];
                var nArr = [];
                if (xlsxOption != '') {
                  dlt_insertColumns.insertJSON(0, [{
                    'columnIndex': ibx_columnIndex.getValue(),
                    'columnValue': ibx_columnValue.getValue()
                  }]);
                  ...
                  for (var idx = 0; idx < xlsxOption.length; idx++) {
                    if (xlsxOption[idx] == 'columnIndex' || xlsxOption[idx] == 'columnValue') {
                      ...
                      nArr.push('\n\t' + xlsxOption[idx] + ' : ' + '"' + value[idx] + '"');
                    }
                  }
                  if (xlsxOption.indexOf('columnIndex') != -1 && xlsxOption.indexOf('columnValue') != -1) {
                    nArr.push('\n\t' + 'insertColumns' + ' : ' + '[{"columnIndex":' + JSON.stringify(dlt_insertColumns.getRowJSON(0).columnIndex) + ', ' + '"columnValue":' + JSON.stringify(dlt_insertColumns.getRowJSON(0).columnValue) + '}]');
                  }
                } else {
              ...
              scwin.btn_uploadData_onclick = function () {
                ...
                if (rad_excelType.getValue() != 'csv') {
                  ...
                  options.insertColumns = [{
                    'columnIndex': ibx_columnIndex.getValue(),
                    'columnValue': ibx_columnValue.getValue()
                  }];
                  com.data.uploadGridViewExcel($p, grd_excelGrid, options);
                } else {
                  options = dma_csvOptionSetting.getJSON();
                  com.data.uploadGridViewCSV($p, grd_excelGrid, options);
                }
              };
              scwin.sdr_moveEvent = function () {
                ...
                var componentSdrId = com.util.getComponentv($p, sdrId);
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                style: '',
                type: 'button',
                userData1: 'tbl_xlsxOptionsSetting'
              },
              E: [{
                T: 1,
                N: 'xf:label'
          ...
          E: [{
            ...
            E: [{
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    ...
                    disabled: '',
                    id: '',
                    ref: 'data:dma_optionsSetting.hidden',
                    renderType: 'radiogroup',
                    rows: '1',
                    selectedIndex: '0',
                    style: ''
              ...
              E: [{
                ...
                A: {
                  ...
                  style: '',
                  tagname: 'th',
                  toolTip: '[defalut : 0] excel파일에서 그리드의 데이터가 있는 sheet번호'
                },
                E: [{
                  T: 1,
                  N: 'w2:textbox',
                ...
                E: [{
                  ...
                  A: {
                    id: '',
                    placeholder: '0',
                    ref: 'data:dma_optionsSetting.sheetNo',
                    style: 'width:100%'
                  }
                }]
              }, {
                ...
                E: [{
                  ...
                  A: {
                    ...
                    disabled: '',
                    id: '',
                    ref: 'data:dma_optionsSetting.fillHidden',
                    renderType: 'radiogroup',
                    rows: '1',
                    selectedIndex: '0',
                    style: ''
              ...
              E: [{
                ...
                A: {
                  ...
                  style: '',
                  tagname: 'th',
                  toolTip: '[defalut : 0] 공백무시 여부(1이면 무시 0이면 포함)'
                },
                E: [{
                  T: 1,
                  N: 'w2:textbox',
                ...
                E: [{
                  ...
                  A: {
                    ...
                    disabled: '',
                    id: '',
                    ref: 'data:dma_optionsSetting.skipSpace',
                    renderType: 'radiogroup',
                    rows: '1',
                    selectedIndex: '0',
                    style: ''
              ...
              E: [{
                ...
                A: {
                  ...
                  style: '',
                  tagname: 'th',
                  toolTip: '[defalut : 0] excel파일에서 그리드의 데이터가 시작되는 열의 번호'
                },
                E: [{
                  T: 1,
                  N: 'w2:textbox',
                ...
                E: [{
                  ...
                  A: {
                    id: 'ibx_columnIndex',
                    readOnly: '',
                    ref: 'data:dma_optionsSetting.columnIndex',
                    style: 'width:45%;',
                  ...
                  A: {
                    id: 'ibx_columnValue',
                    readOnly: '',
                    ref: 'data:dma_optionsSetting.columnValue',
                    style: 'width:45%;',
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    ...
                    placeholder: '0',
                    style: 'width:100%;',
                    ref: 'data:dma_optionsSetting.endColumnIndex'
                  }
                }]
              }, {
                T: 1,
                ...
                E: [{
                  ...
                  A: {
                    id: 'ibx_popupUrl',
                    readOnly: '',
                    ref: 'data:dma_optionsSetting.popupUrl',
                    style: 'width:100%',
                    placeholder: ''
                  }
                }]
              ...
              E: [{
                ...
                A: {
                  tagname: 'th',
                  toolTip: '[defalut : 0] excel파일에서 그리드의 데이터에 header가 있는지 여부(1이면 header 존재 0이면 없음)',
                  "class": 'w2tb_th'
                },
                E: [{
                  T: 1,
                ...
                E: [{
                  ...
                  A: {
                    ...
                    disabled: '',
                    id: '',
                    ref: 'data:dma_optionsSetting.headerExist',
                    renderType: 'radiogroup',
                    rows: '1',
                    selectedIndex: '0',
                    style: ''
                ...
                A: {
                  tagname: 'th',
                  toolTip: '(default : , ) 업로드시 데이터를 구분하는 구분자',
                  "class": 'w2tb_th'
                },
                E: [{
                  T: 1,
                ...
                E: [{
                  ...
                  A: {
                    id: '',
                    readOnly: '',
                    ref: 'data:dma_optionsSetting.delim',
                    style: 'width:100%',
                    placeholder: ','
                  }
                }]
              ...
              E: [{
                ...
                A: {
                  tagname: 'th',
                  toolTip: '[defalut : 1] excel파일에서 그리드의 데이터에 footer가 있는지 여부(1이면 footer 존재 0이면 없음 기본값은 1 그리드에 footer가 없으면 적용되지 않음)',
                  "class": 'w2tb_th'
                },
                E: [{
                  T: 1,
                ...
                E: [{
                  ...
                  A: {
                    ...
                    disabled: '',
                    id: '',
                    ref: 'data:dma_optionsSetting.footerExist',
                    renderType: 'radiogroup',
                    rows: '1',
                    selectedIndex: '1',
                    style: ''
                ...
                A: {
                  tagname: 'th',
                  toolTip: '[defalut : R]업로드된 데이터의 초기 상태값, 설정하지 않으면 "R"로 설정되며 "C"값을 설정 할 수 있다.',
                  "class": 'w2tb_th'
                },
                E: [{
                  T: 1,
                ...
                E: [{
                  ...
                  A: {
                    ...
                    disabled: '',
                    id: '',
                    ref: 'data:dma_optionsSetting.status',
                    renderType: 'radiogroup',
                    rows: '1',
                    selectedIndex: '0',
                    style: '',
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    ...
                    disabled: '',
                    id: '',
                    ref: 'data:dma_optionsSetting.append',
                    renderType: 'radiogroup',
                    rows: '1',
                    selectedIndex: '0',
                    style: ''
                ...
                A: {
                  ...
                  style: '',
                  tagname: 'th',
                  toolTip: '엑셀파일에 암호가 걸려 있는 경우, 비밀번호'
                },
                E: [{
                  T: 1,
                  N: 'w2:textbox',
                ...
                E: [{
                  ...
                  A: {
                    id: '',
                    readOnly: '',
                    ref: 'data:dma_optionsSetting.pwd',
                    style: 'width:100%'
                  }
                }]
              }]
            ...
            E: [{
              ...
              E: [{
                ...
                A: {
                  style: '',
                  toolTip: '[default: 1, 0] 데이터 형태 (0이면 실 데이터 형태,1이면 display 표시 방식)',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  A: {
                    id: 'rad_csvType',
                    ref: 'data:dma_csvOptionSetting.type',
                    selectedIndex: '0',
                    cols: '',
                    appearance: 'full',
                ...
                A: {
                  style: '',
                  toolTip: '[defalut: 0, 1] hidden Column에 대한 저장 여부(0이면 저장하지않음,1이면 저장)',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  A: {
                    id: 'rad_csvHidden',
                    ref: 'data:dma_csvOptionSetting.hidden',
                    cols: '',
                    selectedIndex: '0',
                    appearance: 'full',
                    style: 'width: 150px;height: 21px;',
              ...
              E: [{
                ...
                A: {
                  style: '',
                  toolTip: '[default: 1, 0] Grid header 존재 유무 (0이면 header row수를 무시하고 전부 업로드하고 1이면 header row수 만큼 skip한다.)',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  A: {
                    id: 'rad_csvHeader',
                    ref: 'data:dma_csvOptionSetting.header',
                    selectedIndex: '0',
                    cols: '',
                    appearance: 'full',
                    style: 'width: 150px;height: 21px;',
                ...
                A: {
                  style: '',
                  toolTip: '[defalut: 0, 1] hidden Column에 빈 값을 넣을지를 결정(1이면 hidden Column에 빈 값을 저장하지 않음,0이면 hidden column이 저장되어있지 않은 csv File이라 간주하고 hidden Column에 빈 값을 넣어줌)(hidden이 0인 경우에는 fillhidden은 영향을 끼치지 않음)',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  N: 'xf:select1',
                  A: {
                    id: 'rad_csvFillHidden',
                    ref: 'data:dma_csvOptionSetting.fillHidden',
                    cols: '',
                    selectedIndex: '0',
                    appearance: 'full',
                    style: 'width: 150px;height: 21px;',
              ...
              E: [{
                ...
                A: {
                  style: '',
                  toolTip: '[default: \',\'] CSV 파일에서 데이터를 구분할 구분자',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  A: {
                    id: 'ibx_csvDelim',
                    ref: 'data:dma_csvOptionSetting.delim',
                    style: 'width:88%;height: 21px;',
                    placeholder: ',',
                    initValue: ''
                  }
                }]
                ...
                A: {
                  style: '',
                  toolTip: '[defalut: 0, 1]공백무시 여부(1이면 무시 0이면 포함)',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  A: {
                    id: 'rad_csvSkipSpace',
                    ref: 'data:dma_csvOptionSetting.skipSpace',
                    cols: '',
                    selectedIndex: '0',
                    appearance: 'full',
                    style: 'width: 150px;height: 21px;',
              ...
              E: [{
                ...
                A: {
                  style: '',
                  toolTip: 'CSV 데이터에서 제거해야 되는 문자셋 ( ex) \' \\ \' \' )',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  N: 'xf:input',
                  A: {
                    id: 'ibx_csvEscapeChar',
                    ref: 'data:dma_csvOptionSetting.escapeChar',
                    style: 'width:88%;height: 21px;',
                    placeholder: '0',
                    initValue: ''
                  }
                ...
                A: {
                  style: '',
                  toolTip: '[defalut: 1, 0]expression 컬럼 데이터를 포함하고 있는지 여부, 기본값은 미포함(1이면 미포함, 0이면 포함)',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  N: 'xf:select1',
                  A: {
                    id: 'rad_csvExpression',
                    ref: 'data:dma_csvOptionSetting.expression',
                    cols: '',
                    selectedIndex: '1',
                    appearance: 'full',
                    style: 'width: 150px;height: 21px;',
              ...
              E: [{
                ...
                A: {
                  style: '',
                  toolTip: '[defalut: 0] csv파일에서 그리드의 데이터가 시작되는 행의 번호, startRowIndex가 설정되면, header 설정은 무시된다.',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  N: 'xf:input',
                  A: {
                    id: 'ibx_csvStartRowIndex',
                    ref: 'data:dma_csvOptionSetting.startRowIndex',
                    userData1: '',
                    readOnly: '',
                    style: 'width:88%;height: 21px;',
                    placeholder: '0'
                ...
                E: [{
                  ...
                  A: {
                    id: 'ibx_csvPopupUrl',
                    ref: 'data:dma_csvOptionSetting.popupUrl',
                    style: 'width:88%;height: 21px;',
                    placeholder: '',
                    initValue: ''
                  }
              ...
              E: [{
                ...
                A: {
                  style: '',
                  toolTip: '[defalut: 0, 1]csv파일에서 가져온 데이터를 그리드에 append시킬지 여부(1이면 현재 그리드에 데이터를 추가로 넣어줌 0이면 현재 그리드의 데이터를 삭제하고 넣음)',
                  "class": 'w2tb_th',
                  tagname: 'th'
                },
                E: [{
                ...
                E: [{
                  ...
                  A: {
                    id: 'rad_csvAppend',
                    ref: 'data:dma_csvOptionSetting.append',
                    cols: '',
                    selectedIndex: '0',
                    appearance: 'full',
                    style: 'width: 150px;height: 21px;',
