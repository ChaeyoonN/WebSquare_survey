/*amd /ui/SP/GridView/GridView_Excel_Basic.xml 10111 d5868229b29bceba55ea39f8f81ef782d7e9c06ad17c8cd8f08b1e3bbaa0c470 */
define({
  declaration: {
    A: {
      version: '1.0',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.btn_defaultExcelFormat_onclick = function () {
                ...
                option.dataProvider = 'com.inswave.wrm.provider.ExcelDownHeader';
                var info = {};
                com.data.downloadGridViewExcel($p, grd_excelGrid, option, info);
              };
            }
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                type: 'button',
                style: '',
                id: 'btn_defaultExcelFormat',
                "class": 'btn_cm ',
                toolTip: '그리드의 Header만 엑셀로 다운로드 한다.',
