/*amd /ui/SP/GridView/GridView_PageList.xml 6738 2bfd35077d2078dbe9855e5a7cab072529d5e0d1f7012a2136d59a9287d707d6 */
define({
  declaration: {
    A: {
      version: '1.0',
      ...
      E: [{
        ...
        E: [{
          ...
          A: {
            ...
            target: 'data:json,{"id":"dlt_update","key":"dlt_update"}',
            action: '/page/selectPageInfo',
            method: 'post',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_mainList_submitdone',
            'ev:submiterror': ''
          }
        }]
      }, {
            ...
            with (scopeObj) {
              ...
              scwin.sbm_mainList_submitdone = function (e) {
                if (com.sbm.getResultCode($p, e) == gcm.MESSAGE_CODE.STATUS_SUCCESS) {
                  if (com.util.isEmpty($p, e.responseJSON.TOTAL_CNT) === false) {
              ...
              scwin.searchMain = function (idx, strYn) {
                ...
                dma_search.set('START_NUM', (com.num.parseInt($p, idx) - 1) * 10);
                dma_search.set('END_NUM', 10);
                com.sbm.execute($p, sbm_mainList);
              };
        ...
        E: [{
          ...
          E: [{
            ...
            A: {
              autoFit: 'allColumn',
              "class": 'wq_gvw',
              dataList: 'data:dlt_update',
              'ev:onscrollend': 'scwin.gridView1_onscrollend',
            ...
            A: {
              ...
              style: '',
              'ev:onchange': '',
              'ev:onclick': 'scwin.pgl_list_onclick',
              renderType: ''
            }
          }]
        }]
