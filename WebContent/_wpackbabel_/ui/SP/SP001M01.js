/*amd /ui/SP/SP001M01.xml 18001 3e040c7a41329feaf67ffe0c62b3fd37ce5749fc164a11b0702b61d2684bf1ea */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
      ...
      E: [{
        ...
        E: [{
          ...
          A: {
            ...
            target: 'data:json,dlt_sample',
            action: '/sample/searchSample',
            method: 'post',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_searchSample_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          A: {
            id: 'sbm_saveSample',
            ref: 'data:json,["dlt_sample","dma_search"]',
            target: 'data:json,dlt_sample',
            action: '/sample/updateSample',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              scwin.onpageload = function () {
                ...
                com.util.setGridViewDelCheckBox($p, [grd_sample]);
              };
              scwin.ondataload = function () {
                com.sbm.execute($p, sbm_searchSample);
              };
              ...
              scwin.btn_add_onclick = function () {
                ...
                if (sampleCnt == 0) {
                  com.win.alert($p, '조회 후 이용하세요.');
                  return;
                } else if (com.util.isEmpty($p, dma_search.get('IS_USE', '')) === false) {
                  com.win.alert($p, '사용여부를 전체로 검색한 후에 등록을 수행해야 합니다.');
                  return;
                }
                ...
                var currSampleLevel = com.num.parseInt($p, dlt_sample.getCellData(grd_sample.getFocusedRealRowIndex(), 'SAMPLE_LEVEL'));
                if (sampleCnt != '0' && grd_sample.getFocusedRowIndex() == '-1') {
                  com.win.alert($p, '샘플코드를 클릭하셔야 합니다.');
                } else {
              ...
              scwin.lowerLevel = function () {
                ...
                var orgLevel = com.num.parseInt($p, dlt_sample.getCellData(focusedRowIndex, 'SAMPLE_LEVEL')) + 1;
                var sortOrder = 1;
                ...
                var insertJson = [{
                  'SAMPLE_CD': orgCd,
                  'PARENT_SAMPLE_CD': parentOrgCd,
                  'SAMPLE_LEVEL': orgLevel,
              ...
              scwin.equalLevel = function () {
                ...
                var orgLevel = com.num.parseInt($p, dlt_sample.getCellData(rowIndexArr[rowIndexArr.length - 1], 'SAMPLE_LEVEL'));
                var sortOrder = com.num.parseInt($p, dlt_sample.getCellData(rowIndexArr[rowIndexArr.length - 1], 'SORT_ORDER')) + 1;
                var insertRowIndex = scwin.getInsertRowIndex(parentOrgCd);
              ...
              scwin.btn_save_onclick = function () {
                ...
                if (com.data.isModified($p, dlt_sample)) {
                  if (com.data.validateGridView($p, grd_sample, valInfo)) {
                    com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00001'), function (res) {
                      if (res.clickValue === true) {
                        com.sbm.execute($p, sbm_saveSample);
                      }
                    });
                  }
                } else {
              ...
              scwin.btn_excel_onclick = function () {
                com.data.downloadGridViewExcel($p, grd_sample);
              };
              ...
              scwin.openSample = function (rowIndex, colId, nowValue) {
                ...
                if (filePath !== '') {
                  if (sampleCd === '007002000' && gcm.util.getUserAgent() === 'msie') {
                    com.win.alert($p, com.data.getMessage($p, 'MSG_CM_00051'));
                  } else {
                    var option = {
                      menuType: 'SP',
                      isHistory: false
                    };
                    com.win.openMenu($p, sampleNm, filePath, sampleCd, null, option);
                  }
                }
              };
      ...
      E: [{
        ...
        A: {
          ...
          id: 'grp_content',
          style: '',
          'ev:onclick': 'scwin.grp_content_onclick'
        },
        E: [{
          T: 1,
          N: 'w2:wframe',
          ...
          E: [{
            ...
            A: {
              ...
              editModeEvent: '',
              'ev:oncellclick': 'scwin.grd_sample_oncellclick',
              'ev:oncelldblclick': 'scwin.grd_sample_oncelldblclick',
            ...
            E: [{
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    blockSelect: 'false',
                    customFormatter: 'scwin.displayImage',
                    displayMode: 'label',
                    fixColumnWidth: 'true',
                    id: 'open',
                    imageHeight: '20',
