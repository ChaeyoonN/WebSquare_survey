/*amd /ui/SP/Bean/Bean_Transaction.xml 11598 dd8525682298fe83d2b847edfee97bd6c8666c2d73a8d494a6a2f1b093c10f33 */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
      ...
      E: [{
        ...
        E: [{
          ...
          A: {
            id: 'sbm_selectTemp',
            ref: 'data:json,{"id":"dma_search","key":"param"}',
            target: 'data:json,{"id":"dlt_temp","key":"data"}',
            action: '/sample/bean/tempBeanSelect',
            method: 'post',
          ...
          A: {
            id: 'sbm_saveTemp',
            ref: 'data:json,{"id":"dlt_temp","action":"modified", "key":"param"}',
            target: 'data:json,dma_Result',
            action: '/sample/bean/tempBeanSave',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
