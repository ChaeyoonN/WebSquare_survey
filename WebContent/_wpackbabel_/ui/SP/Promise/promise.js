/*amd /ui/SP/Promise/promise.xml 27617 e0d267d019d01f04fe8f4f750e7b7400189c0e6d26bfdf41f80cb9d6d0587d13 */
define({
  declaration: {
    A: {
      version: '1.0',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.btn_trigger1_onclick = function (e) {
                var promise = com.win.alert($p, 'Step - 1');
                promise = promise.then(function () {
                  console.log('Step - 1');
                }).then(function () {
              ...
              scwin.btn_trigger2_onclick = function (e) {
                var promise = com.win.confirm($p, '확인창');
                promise = promise.then(function (rtn) {
                  if (rtn) {
                    console.log('1차 확인 선택');
              ...
              scwin.btn_trigger5_onclick = function (e) {
                ...
                var promise = com.win.openPopup($p, '/ui/SP/Promise/messageBox1.xml', optsions, data);
                promise = promise.then(function (rtn) {
                  if (rtn) {
                    console.log('샘플 팝업(1) 리턴 파라미터 : ' + rtn);
                  } else {
                ...
                promise = promise.then(function (rtn) {
                  if (rtn) {
                    console.log('샘플 팝업(2) 리턴 파라미터 : ' + com.str.serialize($p, rtn));
                  } else {
                    console.log('샘플 팝업(2) 리턴');
                  }
                });
              ...
              scwin.btn_trigger6_onclick = function (e) {
                var promise = com.sbm.execute($p, sbm_commonCode, {
                  dma_commonCode: {
                    GRP_CD: '00020'
                  }
                });
                promise = promise.then(function (rtn) {
                  ...
                  console.error('[sbm_commonGroup] 통신 에러 발생 : ' + com.str.serialize($p, rtn));
                });
              };
