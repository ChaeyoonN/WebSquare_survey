/*amd /ui/SP/Parameter/SessionStorage_ParameterSend.xml 7531 df0771b9b41fa284c00756d9cec2e7d9f6fa429c25b540b1d64848f776e3bb1e */
define({
  declaration: {
    A: {
      version: '1.0',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.btn_confirm_onclick = function () {
                ...
                var paramObj = {
                  'dataObject': {
                    'type': 'json',
                    'name': 'param',
                    'data': com.data.getParameter($p)
                  }
                };
                com.win.moveUrl($p, moveUrl, paramObj);
              };
              scwin.btn_addTab_onclick = function () {
                ...
                var moveUrl = '/ui/SP/Parameter/SessionStorage_ParameterReceive.xml';
                com.win.openMenu($p, 'session방식 Parameter 전달결과', moveUrl, '999998');
              };
            }
          }
        }]
