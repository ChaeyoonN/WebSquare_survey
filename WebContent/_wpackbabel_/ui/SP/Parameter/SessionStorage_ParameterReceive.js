/*amd /ui/SP/Parameter/SessionStorage_ParameterReceive.xml 5725 cd16c984ec4ba09647b1b1741a7ac2cf4aa4ac5ed02aec43df4b978f54e6ca86 */
define({
  declaration: {
    A: {
      version: '1.0',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.btn_back_onclick = function () {
                ...
                com.win.moveUrl($p, moveUrl, dma_return.getJSON());
              };
              scwin.wfTitleFav_alertPageInfo = function () {
                com.win.alert($p, '[' + wfm_contentHeader.getWindow().txt_h1.getValue() + '] 페이지의 파일 경로는 다음과 같습니다.\n' + com.getPageUrl($p));
              };
