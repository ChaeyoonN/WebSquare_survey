/*amd /ui/SP/Parameter/Popup_Parameter.xml 9194 5582c9727435c9ea88744ed67d6d225b4f86807f5453e420c6ca136cfa681111 */
define({
  declaration: {
    A: {
      version: '1.0',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.btn_alert1_onclick = function () {
                var data = {
                  type: 'alert',
                  msg: ibx_alertSend.getValue(),
                  callbackFn: 'scwin.fn_alertCallback'
                };
                var options = {
                  id: 'AlertPop',
                  title: 'Alert_Pop',
                ...
                com.win.openPopup($p, '/ui/SP/Parameter/confirm.xml', options, data);
              };
              ...
              scwin.btn_confirm1_onclick = function () {
                var data = {
                  type: 'confirm',
                  msg: ibx_confirmSend.getValue(),
                  callbackFn: 'scwin.fn_confirmCallback'
                };
                var options = {
                  id: 'ConfirmPop',
                  title: 'Confirm_Pop',
              ...
              scwin.btn_confirm2_onclick = function () {
                ...
                com.win.openPopup($p, '/ui/SP/Parameter/confirmBrowser.xml', options, data);
              };
                ...
                E: [{
                  ...
                  E: [{
                    ...
                    A: {
                      ...
                      style: '',
                      type: 'button',
                      'ev:onclick': 'scwin.btn_alert1_onclick'
                    },
                    E: [{
                      T: 1,
                      N: 'xf:label',
                    ...
                    A: {
                      "class": 'btn_cm ',
                      'ev:onclick': 'scwin.btn_alert2_onclick',
                      id: 'btn_alert2',
                      style: '',
                      type: 'button',
                      nextTabID: ''
              ...
              E: [{
                ...
                E: [{
                  ...
                  E: [{
                    ...
                    A: {
                      "class": 'btn_cm ',
                      'ev:onclick': 'scwin.btn_confirm2_onclick',
                      id: 'btn_trigger2',
                      nextTabID: '',
                      style: '',
                      type: 'button'
