/*amd /ui/HM/HM001M01.xml 27068 dcc0eebbfde0bbf4057611feac6fe623b460949cfd2e7f946889c3567304d5d7 */
define({
  declaration: {
    A: {
      version: '1.0',
      ...
      E: [{
        ...
        E: [{
          ...
          E: [{
            ...
            N: 'w2:dataList',
            A: {
              id: 'dlt_organizationBasic',
              baseNode: 'list',
              saveRemovedData: 'true',
              repeatNode: 'map',
              'ev:oncelldatachange': '',
              undoRecursiveRow: 'true'
            },
            E: [{
              T: 1,
              N: 'w2:columnInfo',
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_searchOrganization',
            ref: 'data:json,dma_search',
            target: 'data:json,dlt_organizationBasic',
            action: '/organization/searchOrganization',
            method: 'post',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_searchOrganization_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_saveOrganizationBasic',
            ref: 'data:json,{"id":"dlt_organizationBasic","action":"modified"}',
            target: 'data:json,dlt_organizationBasic',
            action: '/organization/updateOrganizationBasic',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '저장중 입니다...',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveOrganizationBasic_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_organizationSearchItem',
            ref: '',
            target: 'data:json,["dlt_organizationSearchItem","dlt_organizationBoss"]',
            action: '/organization/selectOrganizaionSearchItem',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              scwin.onpageload = function () {
                var codeOptions = [{
                  'code': '00020',
                  'compID': 'sbx_OrgClassCd, grd_organizationBasic:ORG_CLASS_CD'
                }];
                com.data.setCommonCode($p, codeOptions);
                com.sbm.execute($p, sbm_organizationSearchItem);
                com.win.setEnterKeyEvent($p, tbl_search, scwin.btn_search_onclick);
                com.util.setGridViewDelCheckBox($p, grd_organizationBasic);
                com.data.setChangeCheckedDc($p, dlt_organizationBasic);
              };
              ...
              scwin.btn_search_onclick = function () {
                ...
                com.sbm.execute($p, sbm_searchOrganization);
              };
              ...
              scwin.btn_addOrganization_onclick = function () {
                ...
                var currOrgLevel = com.num.parseInt($p, dlt_organizationBasic.getCellData(grd_organizationBasic.getFocusedRealRowIndex(), 'ORG_LEVEL'));
                if (org_cnt != '0' && grd_organizationBasic.getFocusedRowIndex() == '-1') {
                  com.win.alert($p, com.data.getMessage($p, 'MSG_CM_00040'));
                } else {
                  if (currOrgLevel < 3) {
              ...
              scwin.selectLevel = function (returnValue) {
                ...
                com.win.confirm($p, returnValue + ' ' + com.data.getMessage($p, 'MSG_CM_00030'), 'scwin.selectLevelCallbak');
              };
              ...
              scwin.lowerLevel = function () {
                ...
                var orgLevel = com.num.parseInt($p, dlt_organizationBasic.getCellData(focusedRowIndex, 'ORG_LEVEL')) + 1;
                var sortOrder = 1;
              ...
              scwin.equalLevel = function () {
                ...
                var orgLevel = com.num.parseInt($p, dlt_organizationBasic.getCellData(rowIndexArr[rowIndexArr.length - 1], 'ORG_LEVEL'));
                var sortOrder = com.num.parseInt($p, dlt_organizationBasic.getCellData(rowIndexArr[rowIndexArr.length - 1], 'SORT_ORDER')) + 1;
                var insertRowIndex = scwin.getInsertRowIndex(parentOrgCd);
              ...
              scwin.getInsertRowOrgCd = function (parentOrgCd, orgLevel, isBottom) {
                ...
                if (OrgCdArr.length > 0) {
                  ...
                  var newNodeCd = com.str.lpad($p, com.num.parseInt($p, preNodeCd) + 1, 2, '0');
              ...
              scwin.btn_cancelOrganization_onclick = function () {
                com.data.undoGridView($p, grd_organizationBasic);
              };
              scwin.btn_saveOrganization_onclick = function () {
                if (com.data.isModified($p, dlt_organizationBasic)) {
                  if (com.data.validateGroup($p, grp_organizationBasic)) {
                    com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00031'), function (res) {
                      if (res.clickValue === true) {
                        com.sbm.execute($p, sbm_saveOrganizationBasic);
                      }
                    });
                  }
                } else {
              ...
              scwin.btn_excelOrganization_onclick = function () {
                com.data.downloadGridViewExcel($p, grd_organizationBasic);
              };
        ...
        E: [{
                  ...
                  E: [{
                    ...
                    E: [{
                      ...
                      E: [{
                        ...
                        N: 'xf:itemset',
                        A: {
                          nodeset: 'data:dlt_organizationSearchItem'
                        },
                        E: [{
                          T: 1,
                          N: 'xf:label',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                "class": 'btn_cm ',
                'ev:onclick': 'scwin.btn_delOrganization_onclick',
                id: 'btn_delOrganization',
                style: 'display:none;',
                type: 'button'
              },
              E: [{
          ...
          E: [{
            ...
            A: {
              ...
              autoFit: 'allColumn',
              "class": 'wq_gvw',
              dataList: 'data:dlt_organizationBasic',
              'ev:oncellclick': '',
              'ev:onrowindexchange': '',
              fixedColumnWithHidden: 'true',
              id: 'grd_organizationBasic',
            ...
            E: [{
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    blockSelect: 'false',
                    customFormatter: 'scwin.setFontFormat',
                    displayMode: 'label',
                    id: 'ORG_CD',
                    inputType: 'text',
                    style: '',
                  ...
                  E: [{
                    ...
                    E: [{
                      ...
                      N: 'w2:itemset',
                      A: {
                        nodeset: 'data:dlt_organizationBasic'
                      },
                      E: [{
                        T: 1,
                        N: 'w2:label',
                  ...
                  E: [{
                    ...
                    E: [{
                      ...
                      N: 'w2:itemset',
                      A: {
                        nodeset: 'data:dlt_organizationBoss'
                      },
                      E: [{
                        T: 1,
                        N: 'w2:label',
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    ...
                    placeholder: '',
                    style: 'width:100%;',
                    ref: 'data:dlt_organizationBasic.ORG_NM',
                    mandatory: 'true'
                  }
                }]
              }]
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    ...
                    disabledClass: 'w2selectbox_disabled',
                    id: 'sbx_OrgClassCd',
                    ref: 'data:dlt_organizationBasic.ORG_CLASS_CD',
                    style: 'width:150px;',
                    submenuSize: 'auto'
                  },
                  E: [{
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    ...
                    disabledClass: 'w2selectbox_disabled',
                    id: 'sbx_OrgBossEmpCd',
                    ref: 'data:dlt_organizationBasic.ORG_BOSS_EMP_CD',
                    style: 'width:150px;',
                    submenuSize: 'auto',
                    chooseOptionLabel: '전체'
                  },
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    ...
                    rightAlign: 'false',
                    style: 'width: 120px;',
                    ref: 'data:dlt_organizationBasic.END_DATE'
                  }
                }]
              }]
            }, {
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    ...
                    ref: 'data:dlt_organizationBasic.NOTE'
                  }
                }]
              }]
            }]
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                "class": 'btn_cm pt',
                'ev:onclick': 'scwin.btn_saveOrganization_onclick',
                id: 'btn_saveOrganization',
                style: '',
                type: 'button'
              },
              E: [{
