/*amd /ui/HM/HM003M01.xml 22754 ea1da459e43984bf02793c92f791cb7764f93650b59a3cdca15108dbd316bd78 */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
      ...
      E: [{
        ...
        E: [{
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_getLoginMemberBasic',
            ref: 'data:json,dma_memberBasic',
            target: '',
            action: '/member/selectMemberOragn',
            method: 'post',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.searchMemberBasicCallback',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_saveMemberInfo',
            ref: 'data:json,{"id":"dma_memberBasic","key":"basic"}',
            target: '',
            action: '/member/saveMemberInfo',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveMemberInfo_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }]
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              scwin.onpageload = function () {
                ...
                scwin.tabDrawStatus = {
                  tab_memberDetail: true,
                  tab_memberFamily: false,
                  tab_memberProject: false
                };
                com.data.setChangeCheckedDc($p, dma_memberBasic);
              };
              scwin.ondataload = function () {
                scwin.searchMemberBasic();
              };
              scwin.searchMemberBasic = function () {
                com.sbm.execute($p, sbm_getLoginMemberBasic);
              };
              ...
              scwin.btn_saveMemberBasic_onclick = function () {
                if (dma_memberBasic.getModifiedIndex().length > 0) {
                  if (com.data.validateGroup($p, grp_memberBasic1) && com.data.validateGroup($p, 'grp_memberBasic2', null, tac_memberInfo, 'tab_memberDetail')) {
                    com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00042'), 'scwin.saveMemberBasicConfirmCallback');
                  }
                } else {
              ...
              scwin.saveMemberBasicConfirmCallback = function (res) {
                if (res.clickValue === true) {
                  com.sbm.execute($p, sbm_saveMemberInfo);
                }
              };
              scwin.btn_cancelMemberBasic_onclick = function () {
                if (dma_memberBasic.getModifiedIndex().length > 0) {
                  com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00043'), 'scwin.cancelMemberBasicConfirmCallback');
                } else {
              ...
              scwin.btn_uploadImage_onclick = function () {
                ...
                var data = {
                  dataSeq: imageDataSeq,
                  callbackFn: 'scwin.uploadImageFileCallback'
                };
                var opt = {
                  id: 'H3P01',
                  popupName: '사진 업로드',
                ...
                com.win.openPopup($p, '/ui/HM/HM003P01.xml', opt, data);
              };
              ...
              scwin.btn_searchOrgan_onclick = function (e) {
                ...
                var data = {
                  'data': rowJSON,
                  callbackFn: 'scwin.searchOrganCallback'
                };
                var opt = {
                  id: 'H3P02',
                  popupName: '조직정보 선택',
                ...
                com.win.openPopup($p, '/ui/HM/HM003P02.xml', opt, data);
              };
              ...
              scwin.btn_changePassword_onclick = function () {
                var data = {
                  'empCd': dma_memberBasic.get('EMP_CD')
                };
                var options = {
                  id: 'settingPassword',
                  popupName: '비밀번호 변경',
                ...
                com.win.openPopup($p, '/cm/xml/settingPassword.xml', options, data);
              };
              scwin.sbm_saveMemberInfo_submitdone = function (e) {
                com.win.alert($p, e.responseJSON.rsMsg.statusMsg, function () {
                  dma_memberBasic.initRowStatus();
            ...
            E: [{
              ...
              E: [{
                ...
                E: [{
                  ...
                  N: 'xf:select1',
                  A: {
                    ref: 'data:dma_memberBasic.JOIN_CLASS_CD',
                    submenuSize: 'auto',
                    appearance: 'minimal',
              ...
              E: [{
                ...
                E: [{
                  ...
                  N: 'xf:select1',
                  A: {
                    ref: 'data:dma_memberBasic.POSITION_CD',
                    submenuSize: 'auto',
                    appearance: 'minimal',
                    disabledClass: 'w2selectbox_disabled',
                    textAlign: 'left',
              ...
              E: [{
                ...
                E: [{
                  ...
                  N: 'xf:select1',
                  A: {
                    ref: 'data:dma_memberBasic.DUTY_CD',
                    submenuSize: 'auto',
                    appearance: 'minimal',
                    disabledClass: 'w2selectbox_disabled',
                    textAlign: 'left',
                ...
                E: [{
                  ...
                  E: [{
                    ...
                    N: 'xf:input',
                    A: {
                      ref: 'data:dma_memberBasic.ORG_NM',
                      style: '',
                      id: 'ibx_orgNm',
                      "class": 'req',
                      mandatory: 'true'
                    ...
                    N: 'xf:trigger',
                    A: {
                      'ev:onclick': 'scwin.btn_searchOrgan_onclick',
                      style: '',
                      id: 'btn_searchOrgan',
                      type: 'button',
              ...
              E: [{
                ...
                E: [{
                  ...
                  N: 'xf:select1',
                  A: {
                    ref: 'data:dma_memberBasic.JOB_FAMILY_CD',
                    submenuSize: 'auto',
                    appearance: 'minimal',
                    disabledClass: 'w2selectbox_disabled',
                    textAlign: 'left',
                ...
                E: [{
                  ...
                  N: 'xf:select1',
                  A: {
                    ref: 'data:dma_memberBasic.JOB_CD',
                    submenuSize: 'auto',
                    appearance: 'minimal',
                    disabledClass: 'w2selectbox_disabled',
                    textAlign: 'left',
              ...
              E: [{
                ...
                E: [{
                  ...
                  N: 'xf:input',
                  A: {
                    ref: 'data:dma_memberBasic.OFFICE_PHONE1',
                    maxlength: '3',
                    style: 'width:60px;',
                    allowChar: '0-9',
                    id: 'ibx_officePhone1'
                  ...
                  N: 'xf:input',
                  A: {
                    ref: 'data:dma_memberBasic.OFFICE_PHONE2',
                    maxlength: '4',
                    style: 'width:60px;',
                    allowChar: '0-9',
                    id: 'ibx_officePhone2'
                  ...
                  N: 'xf:input',
                  A: {
                    ref: 'data:dma_memberBasic.OFFICE_PHONE3',
                    maxlength: '4',
                    style: 'width:60px;',
                    allowChar: '0-9',
                    id: 'ibx_officePhone3'
                ...
                E: [{
                  ...
                  N: 'xf:input',
                  A: {
                    ref: 'data:dma_memberBasic.CELL_PHONE1',
                    maxlength: '3',
                    style: 'width:60px;',
                    allowChar: '0-9',
                    id: 'ibx_cellPhone1',
                  ...
                  N: 'xf:input',
                  A: {
                    ref: 'data:dma_memberBasic.CELL_PHONE2',
                    maxlength: '4',
                    style: 'width:60px;',
                    allowChar: '0-9',
                    id: 'ibx_cellPhone2',
                  ...
                  N: 'xf:input',
                  A: {
                    ref: 'data:dma_memberBasic.CELL_PHONE3',
                    maxlength: '4',
                    style: 'width:60px;',
                    allowChar: '0-9',
                    id: 'ibx_cellPhone3',
                ...
                E: [{
                  ...
                  N: 'xf:input',
                  A: {
                    ref: 'data:dma_memberBasic.EMAIL',
                    invalidMessage: '',
                    isEmail: 'true',
                    validator: '',
                    invalidMessageFunc: '',
