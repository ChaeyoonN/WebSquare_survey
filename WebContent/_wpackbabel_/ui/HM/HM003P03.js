/*amd /ui/HM/HM003P03.xml 11521 f208ea2489d95d075c91be2a172fdeae0877850c95dabb299a9befaa79b9db20 */
define({
  declaration: {
    A: {
      version: '1.0',
      ...
      E: [{
        ...
        E: [{
          ...
          A: {
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.searchCallback',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }]
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              scwin.onpageload = function () {
                ...
                com.win.setEnterKeyEvent($p, grp_search, scwin.btn_searchZip_onclick);
              };
              scwin.btn_searchZip_onclick = function () {
                var searchWord = ibx_searchKeyword.getValue();
                if (com.util.isEmpty($p, searchWord)) {
                  com.win.alert($p, '검색어를 입력하세요');
                } else {
                  txt_baseAddr.setValue('');
                  com.sbm.execute($p, sbm_getZipCodeList);
                }
              };
              ...
              scwin.btn_confirm_onclick = function () {
                ...
                if (focusedRowIndex >= 0) {
                  ...
                  com.win.alert($p, com.data.getMessage($p, 'MSG_CM_00044'));
                }
              };
              ...
              scwin.btn_jibun_onclick = function (e) {
                ...
                var jibun_exp = '찾으시려는 동(읍/면/리)과 번지수 or 건물명을 입력해주세요.';
              ...
              scwin.btn_roadname_onclick = function (e) {
                ...
                var roadname_exp = '찾으시려는 도로명주소의건물번호 또는 건물명까지 상세히 입력 후 검색해 주세요.(도로명주소 확인 : www.juso.go.kr)';
        ...
        E: [{
          ...
          E: [{
            ...
            A: {
              ...
              style: 'width:50%',
              type: 'button',
              'ev:onclick': 'scwin.btn_roadname_onclick'
            },
            E: [{
              T: 1,
              N: 'xf:label',
            ...
            A: {
              "class": '',
              id: 'btn_jibun',
              style: 'width : 50%;background-color: #E0FCF9;',
              type: 'button',
              ...
              E: [{
                ...
                E: [{
                  ...
                  E: [{
                    ...
                    A: {
                      "class": '',
                      id: 'ibx_searchKeyword',
                      placeholder: '주소명(동/읍/면/리/가) 입력',
                      style: 'width:100%;',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                'ev:oncelldblclick': 'scwin.grd_zipCode_oncelldblclick',
                focusMode: 'row',
                id: 'grd_zipCode',
                readOnly: 'true',
                ...
                style: 'height:245px;',
                'ev:oncellclick': 'scwin.grd_zipCode_oncellclick'
              },
              E: [{
                T: 1,
                N: 'w2:caption',
          ...
          E: [{
            ...
            A: {
              "class": 'txt_msg',
              id: 'tbx_textbox1',
              label: '기본주소 선택 후 상세주소를 반드시 입력해주세요. 상세주소가 없는 경우 주소지 특징을 입력해주세요.',
              style: '',
              tagname: ''
            }
          }, {
            ...
            A: {
              ...
              "for": '',
              id: 'txt_textbox2',
              label: '2016년 8월 1일부터는 5자리 우편번호 사용이 의무화됩니다.',
              style: '',
              tagname: ''
            }
          }]
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_addZip_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
