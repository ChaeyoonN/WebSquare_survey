/*amd /ui/BM/BM003M01.xml 24071 e24bd177b01e04e9fbe8cdb78eb4bb3cac6b5f48730aea15167a2e4bf8472056 */
define({
  declaration: {
    A: {
      version: '1.0',
        ...
        E: [{
          ...
          E: [{
            ...
            A: {
              ...
              repeatNode: 'map',
              'ev:oncelldatachange': '',
              'ev:onbeforerowpositionchange': 'scwin.dlt_program_onbeforerowpositionchange'
            },
            E: [{
              T: 1,
              N: 'w2:columnInfo',
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_searchProgram',
            ref: 'data:json,dma_search',
            target: 'data:json,dlt_program',
            action: '/program/searchProgram',
            method: 'post',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_searchProgram_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_saveProgramAll',
            ref: 'data:json,[{"id":"dlt_program","action":"modified"},{"id":"dlt_programAuthority","action":"modified"}]',
            target: '',
            action: '/program/saveProgramAll',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '저장중 입니다...',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveProgramAll_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          A: {
            id: 'sbm_saveProgram',
            ref: 'data:json,[{"id":"dlt_program","action":"modified"},"dma_search"]',
            target: '',
            action: '/program/saveProgram',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '저장중 입니다...',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveProgram_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_searchProgramAuthority',
            ref: 'data:json,dma_program',
            target: 'data:json,dlt_programAuthority',
            action: '/program/searchProgramAuthority',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_searchProgramAuthority_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_saveProgramAuthority',
            ref: 'data:json,[{"id":"dlt_programAuthority","action":"modified"},"dma_program"]',
            target: '',
            action: '/program/saveProgramAuthority',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '저장중 입니다...',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveProgramAuthority_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }]
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.onpageload = function () {
                ...
                com.util.setGridViewDelCheckBox($p, [grd_program, grd_programAuthority]);
                com.data.setChangeCheckedDc($p, [dlt_program, dlt_programAuthority]);
              };
        ...
        E: [{
                ...
                E: [{
                  ...
                  E: [{
                    ...
                    A: {
                      ...
                      id: 'sbx_programGroup',
                      ref: 'data:dma_search.PROGRAM_GROUP_CD',
                      style: 'width:150px;',
                      submenuSize: 'auto',
                      chooseOptionLabel: '',
                      'ev:onchange': 'scwin.sbx_ProgramGroup_onchange'
                    },
                    E: [{
                      T: 1,
                      N: 'xf:choices'
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                "class": 'btn_cm',
                id: 'btn_cancelProgram',
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_cancelProgram_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_saveProgram_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
