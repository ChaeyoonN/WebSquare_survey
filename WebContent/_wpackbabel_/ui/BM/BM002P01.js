/*amd /ui/BM/BM002P01.xml 6914 4b5f2951a85f8305ac6044058b262a48e69957cfb1dd1a324de47b528039a382 */
define({
  declaration: {
    A: {
      version: '1.0',
      ...
      E: [{
        ...
        E: [{
          ...
          A: {
            ...
            target: 'data:json,dlt_member',
            action: '/authority/excludeSelectAuthorityMemberList',
            method: 'post',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.grd_member_oncelldblclick = function (row, col, colId) {
                com.win.closePopup($p, [grd_member.getRowJSON(row)]);
              };
            }
          }
        }]
        ...
        E: [{
          ...
          E: [{
            ...
            A: {
              ...
              'ev:oncelldblclick': 'scwin.grd_member_oncelldblclick'
            },
            E: [{
              T: 1,
              N: 'w2:caption',
