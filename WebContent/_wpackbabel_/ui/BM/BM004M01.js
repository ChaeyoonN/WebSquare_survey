/*amd /ui/BM/BM004M01.xml 21801 876f86f70386faa2f3e909b74ae81411fc6c2114f91bac4c0a6d5c36cb577873 */
define({
  declaration: {
    A: {
      version: '1.0',
      ...
      E: [{
        ...
        E: [{
          ...
          A: {
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_searchMenu_submitdone',
            'ev:submiterror': ''
          }
        }, {
          T: 1,
          N: 'xf:submission',
          A: {
            id: 'sbm_menuSearchItem',
            ref: '',
            target: 'data:json,{"id":"dlt_menuSearchItem","key":"dlt_menu"}',
            action: '/menu/searchMenu',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
          ...
          A: {
            id: 'sbm_saveMenu',
            ref: 'data:json,[{"id":"dlt_menu","action":"modified"},"dma_search"]',
            target: 'data:json,dlt_menu',
            action: '/menu/saveMenu',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '저장중 입니다...',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveMenu_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }]
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              scwin.onpageload = function () {
                com.sbm.execute($p, sbm_menuSearchItem, {});
                com.win.setEnterKeyEvent($p, tbl_search, scwin.btn_search_onclick);
                com.util.setGridViewDelCheckBox($p, [grd_menu]);
                com.data.setChangeCheckedDc($p, dlt_menu);
              };
              ...
              scwin.btn_search_onclick = function () {
                ...
                com.sbm.execute($p, sbm_searchMenu);
              };
              ...
              scwin.btn_addMenu_onclick = function () {
                ...
                var currMenuLevel = com.num.parseInt($p, dlt_menu.getCellData(grd_menu.getFocusedRealRowIndex(), 'MENU_LEVEL'));
                if (menu_cnt != 0 && grd_menu.getFocusedRowIndex() == -1) {
                  com.win.alert($p, com.data.getMessage($p, 'MSG_CM_00029'));
                } else {
                  if (currMenuLevel < 3) {
              ...
              scwin.lowerLevel = function () {
                ...
                var menuLevel = com.num.parseInt($p, dlt_menu.getCellData(focusedRowIndex, 'MENU_LEVEL')) + 1;
                var sortOrder = 1;
              ...
              scwin.getInsertRowMenuCd = function (parentMenuCd, menuLevel, isBottom) {
                ...
                if (menuCdArr.length > 0) {
                  ...
                  var newNodeCd = com.str.lpad($p, com.num.parseInt($p, preNodeCd) + 1, 3, '0');
              ...
              scwin.equalLevel = function () {
                ...
                var rowIndexArr = dlt_menu.getMatchedIndex('PARENT_MENU_CD', parentMenuCd, true, 0, dlt_menu.getTotalRow());
                var menuLevel = com.num.parseInt($p, dlt_menu.getCellData(rowIndexArr[rowIndexArr.length - 1], 'MENU_LEVEL'));
                var sortOrder = com.num.parseInt($p, dlt_menu.getCellData(rowIndexArr[rowIndexArr.length - 1], 'SORT_ORDER')) + 1;
                var insertRowIndex = scwin.getInsertRowIndex(parentMenuCd);
              ...
              scwin.btn_cancelMenu_onclick = function () {
                com.data.undoGridView($p, grd_menu);
              };
              scwin.btn_saveMenu_onclick = function () {
                ...
                if (com.data.isModified($p, dlt_menu)) {
                  if (com.data.validateGridView($p, grd_menu, valMenuInfo)) {
                    com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00031'), function (res) {
                      if (res.clickValue === true) {
                        com.sbm.execute($p, sbm_saveMenu);
                      }
                    });
                  }
                } else {
              ...
              scwin.grd_menu_ontextimageclick = function (row, col) {
                ...
                com.win.openPopup($p, '/ui/BM/BM004P01.xml', options, data);
              };
              ...
              scwin.btn_excelMenu_onclick = function () {
                com.data.downloadGridViewExcel($p, grd_menu);
              };
        ...
        E: [{
                  ...
                  E: [{
                    ...
                    E: [{
                      ...
                      E: [{
                        ...
                        N: 'xf:itemset',
                        A: {
                          nodeset: 'data:dlt_menuSearchItem'
                        },
                        E: [{
                          T: 1,
                          N: 'xf:label',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                'ev:onclick': 'scwin.btn_addMenu_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_cancelMenu_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
          ...
          E: [{
            ...
            A: {
              autoFit: 'allColumn',
              "class": 'wq_gvw',
              dataList: 'data:dlt_menu',
              'ev:oncellclick': 'scwin.grd_menu_oncellclick',
              'ev:oneditkeyup': 'scwin.grd_menu_oneditkeyup',
              'ev:onrowindexchange': '',
              'ev:ontextimageclick': 'scwin.grd_menu_ontextimageclick',
              ...
              E: [{
                ...
                E: [{
                  ...
                  A: {
                    ...
                    id: 'PROGRAM_NM',
                    imageHeight: '14',
                    imageSrc: '../../cm/images/base/g_btn_search.png',
                    imageWidth: '15',
                    inputType: 'textImage',
                    readOnly: '',
                    textAlign: 'left',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_saveMenu_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
