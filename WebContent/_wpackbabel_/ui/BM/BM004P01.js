/*amd /ui/BM/BM004P01.xml 7168 dbf9f197a9496687b2cb929e1ad181e709e8e84809da55f343fb83a886436a73 */
define({
  declaration: {
    A: {
      version: '1.0',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.btn_search_onclick = function () {
                com.sbm.execute($p, sbm_program);
              };
              scwin.btn_confirm_onclick = function () {
                var data = grd_program.getCheckedJSON('chk');
                if (data.length == 1) {
                  com.win.closePopup($p, data[0]);
                }
              };
              scwin.grd_program_oncelldblclick = function (row, col, colId) {
                com.win.closePopup($p, grd_program.getRowJSON(row));
              };
        ...
        E: [{
          ...
          E: [{
            ...
            A: {
              ...
              style: 'height:243px;',
              'ev:onrowindexchange': 'scwin.grd_program_onrowindexchange',
