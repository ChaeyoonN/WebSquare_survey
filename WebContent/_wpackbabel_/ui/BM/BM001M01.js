/*amd /ui/BM/BM001M01.xml 25767 61c80439a5fd736d754f16ba45fcfd82cae73d038198504815f55b8294f60a39 */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
      ...
      E: [{
        ...
        E: [{
          ...
          A: {
            id: 'sbm_saveGrp',
            ref: 'data:json,{"action":"modified","id":"dlt_commonGrp"}',
            target: '',
            action: '/common/saveCommonGrp',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '저장중입니다...',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveGrp_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_saveGrpCodeAll',
            ref: 'data:json,[{"id":"dlt_commonGrp","action":"modified"},{"id":"dlt_commonCode","action":"modified"}]',
            target: '',
            action: '/common/saveCommonGrpAll',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '저장중 입니다...',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveGrpCodeAll_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          A: {
            id: 'sbm_saveCode',
            ref: 'data:json,[{"id":"dlt_commonCode","action":"modified"}]',
            target: '',
            action: '/common/saveCommonCode',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '저장중입니다...',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveCode_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_commonSearchItem',
            ref: '',
            target: 'data:json,dlt_commonSearchItem',
            action: '/common/selectCommonSearchItem',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.onpageload = function () {
                com.sbm.execute($p, sbm_commonSearchItem);
                com.win.setEnterKeyEvent($p, tbl_search, scwin.btn_search_onclick);
                com.util.setGridViewDelCheckBox($p, [grd_commonGrp, grd_commonCode]);
                com.data.setChangeCheckedDc($p, [dlt_commonGrp, dlt_commonCode]);
              };
              ...
              scwin.dlt_commonGrp_onbeforerowpositionchange = function (info) {
                ...
                if (com.data.isModified($p, dlt_commonCode)) {
                  com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00048') + ' ' + com.data.getMessage($p, 'MSG_CM_00001'), scwin.saveCode);
                  return false;
                } else {
                ...
                if (com.data.isModified($p, dlt_commonCode)) {
                  com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00049'), function (res) {
                    if (res.clickValue === true) {
                      com.data.undoAll($p, dlt_commonCode);
              ...
              scwin.btn_addGrpCell_onclick = function () {
                if (com.data.isModified($p, dlt_commonCode)) {
                  com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00050') + ' ' + com.data.getMessage($p, 'MSG_CM_00001'), scwin.saveCode);
                } else {
                  var idx = com.data.insertRow($p, grd_commonGrp);
              ...
              scwin.saveData = function () {
                if (com.data.isModified($p, dlt_commonGrp) && com.data.isModified($p, dlt_commonCode)) {
                  com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00011') + ' ' + com.data.getMessage($p, 'MSG_CM_00010'), scwin.saveGrpCodeAll);
                } else if (com.data.isModified($p, dlt_commonGrp)) {
                  com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00012') + ' ' + com.data.getMessage($p, 'MSG_CM_00010'), scwin.saveGrp);
                } else if (com.data.isModified($p, dlt_commonCode)) {
                  com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00013') + ' ' + com.data.getMessage($p, 'MSG_CM_00010'), scwin.saveCode);
                } else {
              ...
              scwin.validateCodeGroup = function () {
                ...
                return com.data.validateGridView($p, grd_commonGrp, valInfo);
              };
              scwin.validateCode = function () {
                ...
                return com.data.validateGridView($p, grd_commonCode, valInfo);
              };
              scwin.saveGrpCodeAll = function (res) {
                if (res.clickValue === true) {
                  com.sbm.execute($p, sbm_saveGrpCodeAll);
                }
              };
              scwin.saveGrp = function (res) {
                if (scwin.validateCodeGroup()) {
                  if (res.clickValue === true) {
                    com.sbm.execute($p, sbm_saveGrp);
                  }
                }
              };
              scwin.saveCode = function (res) {
                if (scwin.validateCode()) {
                  if (res.clickValue === true) {
                    com.sbm.execute($p, sbm_saveCode);
                  }
                }
              };
              scwin.btn_cancelGrp_onclick = function () {
                com.data.undoGridView($p, grd_commonGrp);
              };
              scwin.btn_addCodeCell_onclick = function () {
                var focusRowIdx = grd_commonGrp.getFocusedRowIndex();
                if (focusRowIdx == -1) {
                  com.win.alert($p, com.data.getMessage($p, 'MSG_CM_00014'));
                } else {
                  var rowStatus = dlt_commonGrp.getRowStatus(focusRowIdx);
                  if (rowStatus == 'C') {
                    com.win.alert($p, com.data.getMessage($p, 'MSG_CM_00015'));
                  } else {
                    var idx = com.data.insertRow($p, grd_commonCode);
              ...
              scwin.btn_cancelCode_onclick = function () {
                com.data.undoGridView($p, grd_commonCode);
              };
              scwin.btn_excelGrp_onclick = function () {
                com.data.downloadGridViewExcel($p, grd_commonGrp);
              };
              scwin.btn_excelCode_onclick = function () {
                com.data.downloadGridViewExcel($p, grd_commonCode);
              };
              ...
              scwin.sbm_saveCode_submitdone = function (e) {
                if (com.sbm.getResultCode($p, e) == gcm.MESSAGE_CODE.STATUS_SUCCESS) {
                  var param = {
                    dma_commonGrp: {
                      GRP_CD: dlt_commonGrp.getCellData(grd_commonGrp.getFocusedRowIndex(), 'GRP_CD')
                    }
                  };
                  com.sbm.execute($p, sbm_commonCode, param);
                }
        ...
        E: [{
                  ...
                  E: [{
                    ...
                    E: [{
                      ...
                      E: [{
                        ...
                        N: 'xf:itemset',
                        A: {
                          nodeset: 'data:dlt_commonSearchItem'
                        },
                        E: [{
                          T: 1,
                          N: 'xf:label',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                "class": 'btn_cm ',
                'ev:onclick': 'scwin.btn_delProgram_onclick',
                id: 'btn_delProgram',
                style: 'display: none;',
                type: 'button'
              },
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_cancelGrp_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_excelGrp_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_addCodeCell_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_cancelCode_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_saveGrpCell_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
