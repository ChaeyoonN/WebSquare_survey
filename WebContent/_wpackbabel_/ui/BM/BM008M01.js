/*amd /ui/BM/BM008M01.xml 11323 b0de7d0642a6e03c4e582161b5ce639218f9035f87c2e0171bbf1e4abbff9f0f */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
      ...
      E: [{
        ...
        E: [{
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_searchMessage',
            ref: 'data:json,dma_search',
            target: 'data:json,{"id":"dlt_msg","key":"dlt_message"}',
            action: '/message/searchMessageList',
            method: 'post',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_searchMessage_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          A: {
            id: 'sbm_saveMessage',
            ref: 'data:json,{"action":"modified","id":"dlt_msg"}',
            target: '',
            action: '/message/saveMessage',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveMessage_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }]
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              scwin.onpageload = function () {
                var codeOptions = [{
                  code: '00027',
                  compID: 'sbx_srchLang, grd_msg:LANG'
                }];
                com.data.setCommonCode($p, codeOptions);
                com.win.setEnterKeyEvent($p, tbl_search, scwin.btn_search_onclick);
                com.util.setGridViewDelCheckBox($p, grd_msg);
                com.data.setChangeCheckedDc($p, dlt_msg);
              };
              scwin.ondataload = function () {
                scwin.btn_search_onclick();
              };
              scwin.btn_search_onclick = function () {
                com.sbm.execute($p, sbm_searchMessage);
              };
              ...
              scwin.btn_addMsg_onclick = function (e) {
                var idx = com.data.insertRow($p, grd_msg);
              ...
              scwin.btn_cancelMsg_onclick = function (e) {
                com.data.undoGridView($p, grd_msg);
              };
              scwin.btn_saveMsg_onclick = function (e) {
                if (com.data.isModified($p, dlt_msg)) {
                  var valInfo = [{
                    id: 'LANG',
                    mandatory: true
                  }, {
                  ...
                  if (com.data.validateGridView($p, grd_msg, valInfo)) {
                    com.win.confirm($p, '저장하시겠습니까?', function (res) {
                      if (res.clickValue === true) {
                        com.sbm.execute($p, sbm_saveMessage);
                      }
                    });
                  }
                } else {
              ...
              scwin.btn_excelMenu_onclick = function (e) {
                com.data.downloadGridViewExcel($p, grd_msg);
              };
            }
          }
        }]
                ...
                E: [{
                  ...
                  E: [{
                    ...
                    A: {
                      ...
                      id: 'ibx_srchMSg',
                      style: 'width:100%',
                      ref: 'data:dma_search.MSG_CONTENTS'
                    }
                  }]
                }, {
                  T: 1,
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                'ev:onclick': 'scwin.btn_addMsg_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_cancelMsg_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
          ...
          E: [{
            ...
            E: [{
              ...
              A: {
                ...
                style: '',
                type: 'button',
                'ev:onclick': 'scwin.btn_saveMsg_onclick'
              },
              E: [{
                T: 1,
                N: 'xf:label',
