/*amd /ui/BM/BM006M01.xml 16041 5bf015c4b99640a6dc290ef21d9160d2588d5b96179d9678cc9e7eed5060d583 */
define({
  declaration: {
    A: {
      version: '1.0',
    ...
    E: [{
      ...
      E: [{
        ...
        E: [{
          ...
          N: 'xf:submission',
          A: {
            id: 'sbm_selectFileGrp',
            ref: 'data:json,dma_search',
            target: 'data:json,dlt_fileGroup',
            action: '/file/selectFileGrp',
            method: 'post',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_selectFileGrp_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }, {
          ...
          A: {
            id: 'sbm_selectFile',
            ref: 'data:json,dma_search',
            target: 'data:json,dlt_file',
            action: '/file/selectFileByFileGrp',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
          ...
          A: {
            id: 'sbm_saveFileGrp',
            ref: 'data:json,dma_fileGrp',
            target: '',
            action: '/file/saveFileGrp',
            method: 'post',
            mediatype: 'application/json',
            encoding: 'UTF-8',
            instance: '',
            ...
            processMsg: '',
            'ev:submit': '',
            'ev:submitdone': 'scwin.sbm_saveFileGrp_submitdone',
            'ev:submiterror': '',
            abortTrigger: ''
          }
        }]
          ...
          cdata: function cdata(scopeObj) {
            with (scopeObj) {
              ...
              scwin.onpageload = function () {
                ...
                com.data.setChangeCheckedDc($p, [dlt_file, dlt_fileGroup]);
              ...
              scwin.btn_search_onclick = function () {
                com.sbm.execute($p, sbm_selectFileGrp);
              };
              ...
              scwin.searchFile = function (idx, totalYn) {
                ...
                com.sbm.execute($p, sbm_selectFile);
              };
              scwin.btn_add_onclick = function () {
                ...
                if (dlt_fileGroup.getRowCount() > 0) {
                  ...
                  if (selectRowIdx === null) {
                    com.win.alert($p, com.data.getMessage($p, 'MSG_CM_00033'));
                  } else {
                ...
                com.win.openPopup($p, '/ui/BM/BM006P01.xml', options, data);
              };
              ...
              scwin.btn_delete_onclick = function () {
                if (trv_fileGroup.isLeaf() == false) {
                  com.win.alert($p, com.data.getMessage($p, 'MSG_CM_00034'));
                } else if (dlt_file.getRowCount() > 0) {
                  com.win.alert($p, com.data.getMessage($p, 'MSG_CM_00035'));
                } else {
                  com.win.confirm($p, com.data.getMessage($p, 'MSG_CM_00036'), function (res) {
                    if (res.clickValue === true) {
                      dma_fileGrp.setJSON(dlt_fileGroup.getRowJSON(dlt_fileGroup.getRowPosition()));
                      dma_fileGrp.set('mapStatus', 'D');
                      com.sbm.execute($p, sbm_saveFileGrp);
                    }
                    ;
                  });
                }
              ...
              scwin.sbm_selectFile_submitdone = function (e) {
                if (com.sbm.getResultCode($p, e) == gcm.MESSAGE_CODE.STATUS_SUCCESS) {
                  ...
                  if (firstYn == 'Y') {
                    ...
                    var totalCnt = com.num.ceil($p, fileTotalCnt / scwin.pageItemCnt);
                ...
                E: [{
                  ...
                  E: [{
                    ...
                    A: {
                      ...
                      placeholder: '',
                      style: 'width:100%;',
                      ref: 'data:dma_search.ORIGIN_FILE_NM'
                    }
                  }]
                }, {
                  T: 1,
            ...
            E: [{
                  ...
                  E: [{
                    ...
                    E: [{
                      ...
                      A: {
                        ...
                        label: '',
                        style: '',
                        ref: 'data:dlt_fileGroup.FILE_GRP_SEQ'
                      }
                    }]
                  }, {
                    T: 1,
                    ...
                    E: [{
                      ...
                      A: {
                        ...
                        label: '',
                        style: '',
                        ref: 'data:dlt_fileGroup.FILE_GRP_NM'
                      }
                    }]
                  }, {
                    T: 1,
              ...
              E: [{
                ...
                A: {
                  ...
                  displayFormat: '#',
                  'ev:onclick': 'scwin.pgl_file_onclick',
                  id: 'pgl_file',
                  pageSize: '5',
                  pagingType: '0',
                  style: '',
